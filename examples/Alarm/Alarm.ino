 ...
 *
 * @file        Alarm.ino
 * @brief       This example shows How to use alarm with DS18B20 sensor
 *
 *
 *
...
// Data wire is plugged into pin 11 on the controler
...
void printTemperature(DeviceAddress deviceAddress)
{
    ...
    Serial.print(tempC);
    Serial.print(" Temp F: ");
    Serial.print(DS18B20::toFahrenheit(tempC));
}
...
void printAlarms(uint8_t deviceAddress[])
{
    ...
    Serial.print("C/");
    Serial.print(DS18B20::toFahrenheit(temp));
